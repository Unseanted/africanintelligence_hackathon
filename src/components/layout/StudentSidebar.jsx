...
const StudentSidebar = () => {
  ...
  const [gamificationOpen, setGamificationOpen] = useState(
    location.pathname.startsWith('/student/gamification')
  );
  ...
  useEffect(() => {
    ...
    setChallengesOpen(location.pathname.startsWith('/student/challenges'));
    setLessonsOpen(location.pathname.startsWith('/student/lessons'));
    setGamificationOpen(location.pathname.startsWith('/student/gamification'));
  }, [location.pathname]);
    ...
    <div className="flex h-screen flex-col border-r bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="flex flex-col p-4">
        ...
        <div className="space-y-1">
          ...
          <Collapsible open={gamificationOpen} onOpenChange={setGamificationOpen}>
            <CollapsibleTrigger asChild>
              <Button variant="ghost" className="w-full justify-between mb-1">
                <div className="flex items-center">
            ...
            <CollapsibleContent>
              <Link to="/student/gamification/progress">
                <Button 
                  variant="ghost" 
                  className={cn(
                    "w-full justify-start mb-1 pl-8",
                    location.pathname === '/student/gamification/progress' ? "bg-muted text-primary font-medium" : "hover:bg-muted/50"
                  )}
                >
                  My Progress
                </Button>
              </Link>
              <Link to="/student/gamification/leaderboard">
                <Button 
                  variant="ghost" 
                  className={cn(
                    "w-full justify-start mb-1 pl-8",
                    location.pathname === '/student/gamification/leaderboard' ? "bg-muted text-primary font-medium" : "hover:bg-muted/50"
                  )}
                >
                  Leaderboards
                </Button>
              </Link>
              <Link to="/student/gamification/achievements">
                <Button 
                  variant="ghost" 
                  className={cn(
                    "w-full justify-start mb-1 pl-8",
                    location.pathname === '/student/gamification/achievements' ? "bg-muted text-primary font-medium" : "hover:bg-muted/50"
                  )}
                >
                  Achievements
                </Button>
